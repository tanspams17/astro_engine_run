...
NUMBER_ESSENCE = {
    ...
    2: "the Moon's number: sensitivity, diplomacy, and imagination. Twos read moods with uncanny accuracy and hold relationships together quietly. Their strength looks soft but is solid underneath, built on patience, timing, and emotional intelligence. The watch-out is absorbing everyone's weather and calling it their own.",
    ...
    8: "Saturn's number: discipline, endurance, and late-blooming success. Eights carry heavy loads early and build things that last; their word is their contract. Life tests them more, then pays better. The watch-out is all work and delayed joy.",
...
KARMIC_DEBT_TEXT = {
    13: "Born on the 13th, you carry karmic number 13, the lesson of honest work. Shortcuts collapse for you faster than for others; steady, transparent effort compounds unusually well. It's a strict teacher, and the success it produces lasts.",
    14: "Born on the 14th, you carry karmic number 14, the lesson of freedom with self-control. Life gives you variety and temptation in equal measure; moderation is your multiplier. When you master your appetites, your adaptability becomes one of your biggest strengths.",
...
MISSING_NUMBER = {
    ...
    4: "Missing 4 (Rahu): structure and routine don't come pre-installed. External systems such as lists, fixed hours and one place for everything pay off far more than you'd expect.",
    ...
    6: "Missing 6 (Venus): domestic ease and self-care need scheduling rather than waiting for the mood. For this grid, beautifying your space is practical rather than indulgent.",
...
PERSONAL_MONTH = {
    ...
    3: dict(theme="Expression & luck",
            ...
            tips="Publish, present, host, pitch. Your words carry further than usual, so aim them at what you actually want."),
    ...
    5: dict(theme="Change & movement",
            ...
            tips="Say yes to trips, meetings and experiments, but keep contracts short. Flexibility is the asset this month."),
    6: dict(theme="Home & responsibility",
            positive="family matters resolving, domestic upgrades, being needed, love strengthening",
...
JUPITER_NOTE_HARD = ("Jupiter transits your {h} house from the Moon. Expansion this month works quietly, and growth comes through consolidation rather than leaps.")
...
SATURN_NOTE_HARD = ("Saturn transits your {h} house from the Moon and asks for patience here; keep commitments modest, honour routines, and let slow be smooth.")
SADE_SATI_NOTE = ("You are in a Sade Sati window (Saturn near your natal Moon). Tradition reads this as a maturing pressure rather than bad luck: simplify, keep your word, protect rest, and this period can strengthen you rather than weigh you down.")
...
MONTHLY_INTRO = (
    ...
    "Nothing here predicts events; it is guidance on timing.")
