...
NAKSHATRAS = {
    ...
    "Ardra": ("a teardrop", "Rahu",
        "Ardra, ruled by Rudra the storm god, is the nakshatra of the clearing storm. People born under it tend to live through real upheavals and come out renewed, with an intellectual sharpness and emotional depth that easier lives rarely develop. The temperament is penetrating, honest and sometimes turbulent. Its lesson is trusting the storm's function: what it strips away was usually ready to go, and the fresh air afterward is the point."),
    "Punarvasu": ("a quiver of arrows", "Jupiter",
        "Punarvasu means 'return of the light', the nakshatra of renewal after the storm. It gives a rare kind of resilience: the ability to lose ground and begin again, often better. People born under it tend to be philosophical, adaptable and decent; homes and hearts recover in their presence. Its lesson is commitment. When you know you can always start over, finishing becomes the challenge worth choosing."),
    ...
    "Ashlesha": ("a coiled serpent", "Mercury",
        "Ashlesha is the serpent nakshatra, with penetrating insight, hypnotic charm, and an instinctive grasp of human motivation. People born under it read subtext fluently; very little gets past them. That awareness can heal (they make superb counselors and strategists) or entangle, depending on how it's used. The temperament is private and perceptive. Its lesson is straightness: the serpent's wisdom is real, but trust is built in straight lines rather than coils."),
    "Magha": ("a royal throne", "Ketu",
        "Magha is the nakshatra of ancestry and rightful authority. People born under it often carry a natural dignity and a strong pull toward legacy. Family history, lineage and doing right by those who came before all matter. Leadership tends to find them. The temperament is generous, proud, and tradition-respecting. Its lesson is that thrones are seats of service: authority kept for its own sake hollows out; authority used for others compounds."),
    ...
    "Vishakha": ("a triumphal archway", "Jupiter",
        "Vishakha is the nakshatra of determined pursuit, the archway you pass under after the campaign is won. People born under it have exceptional goal-focus: patient, strategic, and undeterred by obstacles that stop others. Ambition here is real and usually earned. The temperament is purposeful and passionate. Its lesson is presence: a life aimed entirely at the next archway forgets to notice the road, and the road is most of the life."),
    ...
    "Mula": ("a bundle of roots", "Ketu",
        "Mula means 'root', the nakshatra that digs to the bottom of things. People born under it are natural investigators of foundations: of ideas, of institutions, of themselves. They can dismantle what's false with startling thoroughness, and their lives often include a real reinvention. The temperament is direct, philosophical, and unafraid of endings. Its lesson is gentleness in the digging, since not everything that can be uprooted needs to be."),
    "Purva Ashadha": ("a fan, or water rising", "Venus",
        "Purva Ashadha is the invincible nakshatra of early victory, rising water and undefeatable optimism. People born under it carry real confidence and persuasive power; they lift rooms and rally teams, and they rarely accept that something can't be done. The temperament is proud, buoyant, and ambitious. Its lesson is listening: conviction this strong can stop taking in new information. The water that rises highest is fed by many streams."),
    "Uttara Ashadha": ("an elephant's tusk", "Sun",
        "Uttara Ashadha is the nakshatra of the lasting victory, the one that stands long after quick wins fade. People born under it tend toward integrity that others eventually organize around; they may start slow, but what they build endures. Leadership here is earned through consistency rather than charisma. The temperament is honorable, patient, and quietly immovable. Its lesson is starting before certainty: the tusk grows while the elephant walks."),
    "Shravana": ("an ear", "Moon",
        "Shravana is the nakshatra of listening, of sacred learning received through hearing. People born under it are natural students and eventually natural teachers: they absorb, connect, and transmit knowledge, and others trust their counsel. The temperament is thoughtful, orderly, and curious about people. Its lesson is acting on what's heard: perpetual students can hide in the next course, the next book. At some point, the ear must inform the hand."),
    "Dhanishta": ("a drum", "Mars",
        "Dhanishta is the drum, the nakshatra of rhythm, resonance, and wealth that gathers around skill. People born under it often have musical or rhythmic gifts, literal or metaphorical: timing, cadence, knowing when to move. Group endeavors amplify them. The temperament is energetic, ambitious, and performance-ready. Its lesson is inner resonance. A drum is hollow by design, but a person isn't, so fill the private life as carefully as the public one."),
    ...
    "Revati": ("a fish swimming in the sea", "Mercury",
        "Revati is the final nakshatra, the fish in the boundless sea and the safe passage at journey's end. People born under it are natural protectors of travelers, animals, and anyone in transition; their compassion is instinctive rather than performed. Creative and spiritual gifts are common. The temperament is gentle, generous, and dreamier than the world always accommodates. Its lesson is boundaries: a heart open to every current needs a shore of its own."),
}
...
DASHA_INTRO = (
    ...
    "as which themes are foregrounded, or which teacher is at the front of the "
...
DASHA_LORDS = {
    ...
    "Rahu": "A Rahu mahadasha foregrounds ambition and unfamiliar territory. Rahu is the hungry node, and this chapter tends to pull you toward what you've never had: new fields, foreign places, larger stages, unconventional paths. Gains can be substantial and fast; so can obsession. It rewards bold experiments held with self-awareness; its trap is mistaking appetite for direction. Keep asking what the hunger is actually for.",
    "Jupiter": "A Jupiter mahadasha foregrounds growth, wisdom, and fortune-through-alignment. This chapter tends to expand whatever you sincerely invest in: learning, teaching, family, faith, long-term ventures. Mentors and opportunities appear more readily. It rewards generosity and principled choices; its subtle trap is complacency, because Jupiter's ease can make effort feel optional. Classical counsel: in the season of favor, plant heavily.",
    "Saturn": "A Saturn mahadasha foregrounds structure, endurance, and the long game. This chapter tends to slow things down and test foundations: what's solid consolidates, and what's hollow is revealed. Responsibility increases; shortcuts stop working. It is, by tradition, the great maturer: people often emerge from Saturn periods with their most durable achievements and their clearest sense of what actually matters. The counsel is simple: do the work, keep your word, rest properly.",
    "Mercury": "A Mercury mahadasha foregrounds intellect, communication, and commerce. This chapter tends to accelerate learning, writing, trade, and networks, and ideas become assets. Wit sharpens and options multiply. It rewards skill-building and clear speech; its trap is scatter, since Mercury opens many doors and closes none. The practice of this period is curation: choose which conversations, projects, and skills deserve the full mind.",
...
SYNTHESIS_INTRO = (
    ...
    "Think of them as two calibrated instruments measuring from different "
    "reference points. The most useful way to read them "
    "together: Western astrology tends to describe the psychological weather, "
    "meaning personality as experienced from inside. Jyotish tends to describe "
    "the karmic terrain: patterns, timings, and territories as seen from above. "
